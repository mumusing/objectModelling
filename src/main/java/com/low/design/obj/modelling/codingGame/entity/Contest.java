...
public class Contest extends BaseEntity{
    ...
    public Contest(String id, String name, List<Question> questions, Level level, User creator, ContestStatus contestStatus) {
    ...
    private void validateQuestionList(List<Question> questions, Level level) {
    }
