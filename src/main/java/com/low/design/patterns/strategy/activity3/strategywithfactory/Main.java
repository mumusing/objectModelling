...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        account1.setInterestStrategy(InterestStrategyFactory.createStrategy(StrateyType.COMPOUND));
        ...
        account2.setInterestStrategy(InterestStrategyFactory.createStrategy(StrateyType.SIMPLE));
